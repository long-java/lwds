        ...
        <center>
            <div class="flex flex-wrap max-w-xl">
                ...
                <div class="p-2 w-full mt-4">
                    <button @click.prevent="saveForm" type="submit" class="btn btn-danger flex text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Register</button>
                </div>
            </div> 

            <router-link class="nav-link" 
                :class="[{active: $route.name === 'login'}]" to="/login"> Đăng nhập?
            </router-link>
        </center>
    ...
    <div class="container right-panel-active" id="container">
        <div class="form-container sign-up-container">
            <form @submit="saveForm" method="post">
				...
				<input type="password" placeholder="Password" v-model="form.password_confirmation" />

                <button @click.prevent="saveForm" type="submit">Sign Up</button>
            </form>
