                                        ...
                                        <v-card-text>
                                            <v-container>
                                                ...
                                                <!-- <v-col cols="12" sm="6" md="12">
                                                    <v-text-field v-model="editedItem.room_name" label="RoomName"></v-text-field>
                                                </v-col>
...
<script>
  export default {
    data: () => ({
      ...
      dialogDelete: false,
      headers: [
        { text: 'id', value: 'id', width: '9%' },
        { text: 'room', align: 'start', sortable: true, value: 'room_name', width: '10%'},
        { text: 'user', value: 'user_name',width: '10%' },
        { text: 'message', value: 'message', width: '30%' },
        { text: 'created_at', value: 'created_at', sortable: true, width: '25%' },
    ...
    methods: {
      ...
      initialize () {
        ...
        .then((res) =>{
          ...
          this.desserts = res.data.messages;
        });
      ...
      save () {
        ...
        //check null
        if(this.editedItem.room_name == "" || this.editedItem.user_name == "" || this.editedItem.message == "" ){
        ...
        if (this.editedIndex > -1) {
          ...
          axios.put("/api/message/"+this.editedItem.id,{
